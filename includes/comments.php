 ...
 */
function app_render_comment( $comment, $args, $depth ) {
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		<div id="comment-<?php comment_ID(); ?>" class="comment__entry">
			<div class="comment__author vcard">
				...
				<span class="comment__author-says"><?php _e( 'says:', 'app' ); ?></span>
			</div><!-- /.comment__author -->
			...
			<div class="comment__meta">
				<a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ); ?>">
					<?php printf( __( '%1$s at %2$s', 'app' ), get_comment_date(), get_comment_time() ); ?>
				</a>
