        ...
        <div class="shell shell--small">
            <div class="post">
                <div class="post__title" data-aos="fade-up">
                    <h1 class="h2">Terms &amp; Conditions</h1><!-- /.h2 -->
                ...
                <div class="post__entry" data-aos="fade-up">
                    ...
                    <ul>
                        ...
                        <li>Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to All Vision Development ULC, 2275 Upper Middle Road East, Suite 101, Oakville, Ontario L6H 0C3.</li>
                        ...
                        <li>Website refers to Allvision Canada, accessible from allvision.ca</li>
                    ...
                    <ul>
                        <li>By email: <a href="mailto:info@allvision.com">info@allvision.com</a></li>
                    </ul>
                </div><!-- /.post__entry -->
            </div><!-- /.post -->
        </div><!-- /.shell -->
