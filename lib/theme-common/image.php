<?php
function app_get_image_thumbnail( $attachment_id, $width, $height, $crop=true ) {
	$width = absint( $width );
	...
	$attachment_realpath = app_normalize_path( $attachment_path );
	...
	$filepath = app_normalize_path( $filepath );
