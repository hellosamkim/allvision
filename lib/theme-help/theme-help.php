...
if ( function_exists( 'add_action' ) ) {
	add_action( 'admin_menu', 'app_add_theme_readme', 11 );
}

function app_add_theme_readme() {
	...
	add_menu_page( __( 'Theme Help', 'app' ), __( 'Theme Help', 'app' ), 'administrator', 'theme-readme', 'app_include_theme_help', 'dashicons-editor-help' );
}

function app_include_theme_help() {
	...
	$readme_paths = apply_filters( 'app_help_readme_paths', $readme_paths );
