 ...
 */
class Theme_Fragment_Test extends WP_UnitTestCase {
    ...
    function test_constructor_SingleFragment_Found() {
        $fragment = new Theme_Fragment('test-1');
    ...
    function test_constructor_SingleFragmentWithDirectory_Found() {
        $fragment = new Theme_Fragment('fragments/test-1');
        $fragment = new Theme_Fragment('/fragments/test-1');
    ...
    function test_constructor_SingleFragmentWithExtension_Found() {
        $fragment = new Theme_Fragment('test-1.php');
    ...
    /**
     * @expectedException     Theme_Fragment_Exception
     * @expectedExceptionCode 1
     */
    function test_constructor_SingleFragment_NotFound() {
        $fragment = new Theme_Fragment('nonexistant-1');
    }

    function test_constructor_MultipleFragments_Found() {
        $fragment = new Theme_Fragment(array('test-2', 'test-1'));
    ...
    function test_constructor_MultipleFragments_SecondFragmentHTML() {
        $html = Theme_Fragment::create(array('test-2', 'test-1'))->get();
    ...
    function test_constructor_MultipleFragments_NotFound() {
        $fragment = new Theme_Fragment(array('nonexistant-2', 'nonexistant-1'));
    }

    function test_constructor_MultipleFragments_FallbackFound() {
        $fragment = new Theme_Fragment(array('nonexistant-1', 'test-1'));
    ...
    function test_constructor_CorrectContext_NoException() {
        $fragment = new Theme_Fragment('test-1', array(
            'foo'=>'bar',
            'bar'=>'foo',
        ));
    ...
    function test_constructor_IncorrectContext_Exception() {
        $fragment = new Theme_Fragment('test-1', new stdClass());
    }

    function test_cache() {
        $fragment = Theme_Fragment::create('test-1')->cache(1);
        $html = $fragment->get();
    ...
    function test_get() {
        $html = Theme_Fragment::create('test-1')->cache(1)->get();
        $expected_html = $this->testFragment1;
        $this->assertEquals($expected_html, $html, 'Returned html is not the expected one');
    }
    ...
    function test_render() {
        $expected_html = $this->testFragment1;
        ob_start();
        Theme_Fragment::create('test-1')->cache(1)->render();
        $html = ob_get_clean();
