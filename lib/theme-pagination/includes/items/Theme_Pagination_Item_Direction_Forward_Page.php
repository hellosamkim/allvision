<?php
/**
 * The Theme Pagination direction forward page item class.
 ...
 */
abstract class Theme_Pagination_Item_Direction_Forward_Page extends Theme_Pagination_Item_Direction_Page {
