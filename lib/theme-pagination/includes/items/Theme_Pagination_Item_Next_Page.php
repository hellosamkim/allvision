<?php
/**
 * The Theme Pagination next page item class.
 *
 * @uses Theme_Pagination_Item_Direction_Forward_Page
 */
class Theme_Pagination_Item_Next_Page extends Theme_Pagination_Item_Direction_Forward_Page {
