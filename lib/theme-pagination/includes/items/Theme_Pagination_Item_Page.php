 ...
 */
class Theme_Pagination_Item_Page extends Theme_Pagination_Item {
	...
	public function setup() {
		...
		$url = $pagination->get_page_url( $page_number, Theme_Pagination_Utilities::get_current_url() );
	...
	public function render() {
		...
		$html = apply_filters( 'theme_pagination_page_link', $html, $this );
