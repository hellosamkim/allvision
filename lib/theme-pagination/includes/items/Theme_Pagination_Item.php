<?php
/**
 * The Theme Pagination item class.
 * Corresponds to a particular item of the pagination.
 */
class Theme_Pagination_Item {
	...
	/**
	 * @var Theme_Pagination_Collection|bool
	 * 
	 ...
	 *
	 * @return Theme_Pagination_Collection $subitems_collection The item subitems collection.
	 */
	 ...
	 *
	 * @param Theme_Pagination_Collection $subitems_collection The new item subitems collection.
	 */
	public function set_subitems_collection( Theme_Pagination_Collection $subitems_collection ) {
