<?php
/**
 * The Theme Pagination direction page item class.
 ...
 */
abstract class Theme_Pagination_Item_Direction_Page extends Theme_Pagination_Item {
	...
	public function init() {
		...
		$subitems_collection = Theme_Pagination_Item_Page::generate_single_subitem_collection( $collection, $html, $page );
