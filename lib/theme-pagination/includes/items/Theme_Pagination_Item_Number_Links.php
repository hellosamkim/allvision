<?php
/**
 * The Theme Pagination number links item class.
 * Responsible for the "1, 2, 3, ..., 10, 20, 30" pagination item.
 *
 * @uses Theme_Pagination_Item
 */
class Theme_Pagination_Item_Number_Links extends Theme_Pagination_Item {
	...
	public function init() {
		...
		$subitems_collection = new Theme_Pagination_Collection( $pagination, false );
	...
	public function generate_limiters() {
		...
		$limiter_item = new Theme_Pagination_Item_Limiter( $collection );
	...
	public function generate_wrappers() {
		...
		if ( $total_subitems ) {
			...
			$wrapper_before = new Theme_Pagination_Item_HTML( $collection );
			...
			$wrapper_after = new Theme_Pagination_Item_HTML( $collection );
