<?php
/**
 * The Theme Pagination direction backward page item class.
 * Used for prev & first items.
 * Should be extended by each one of them.
 *
 * @abstract
 *
 * @uses Theme_Pagination_Item_Direction_Page
 */
abstract class Theme_Pagination_Item_Direction_Backward_Page extends Theme_Pagination_Item_Direction_Page {
