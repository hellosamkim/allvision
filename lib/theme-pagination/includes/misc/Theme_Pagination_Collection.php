...
class Theme_Pagination_Collection {
	 ...
	 *
	 * @param Theme_Pagination_HTML $pagination Pagination object.
	 * @param bool $autogenerate Whether to automatically generate pagination items.
	 */
	public function __construct( Theme_Pagination_HTML $pagination, $autogenerate = true ) {
		$this->set_pagination( $pagination );

		// whether to auto generate pagination items
		$autogenerate = apply_filters( 'theme_pagination_autogenerate_collection_items', $autogenerate, $this );
		if ( $autogenerate ) {
			$this->generate();
		}
	}
	...
	public function generate() {
		...
		do_action( 'theme_pagination_collection_after_generate', $this );
	}
	...
	public function get_item_prototypes() {
		...
		$item_classes = array(
			'get_enable_current_page_text' => 'Theme_Pagination_Item_Current_Page_Text',
			'get_enable_first' => 'Theme_Pagination_Item_First_Page',
			'get_enable_prev' => 'Theme_Pagination_Item_Previous_Page',
			'get_enable_numbers' => 'Theme_Pagination_Item_Number_Links',
			'get_enable_next' => 'Theme_Pagination_Item_Next_Page',
			'get_enable_last' => 'Theme_Pagination_Item_Last_Page',
		);

		// allow default methods => items to be filtered
		return apply_filters( 'theme_pagination_default_collection_items', $item_classes, $this );
	}
	 ...
	 *
	 * @return Theme_Pagination_HTML $pagination The pagination object.
	 */
	 ...
	 *
	 * @param Theme_Pagination_HTML $pagination The new pagination object.
	 */
	public function set_pagination( Theme_Pagination_HTML $pagination ) {
