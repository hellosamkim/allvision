...
class Theme_Pagination_Posts extends Theme_Pagination_HTML {
	...
	public function __construct( $args = array() ) {
		...
		$this->default_args = array(
			...
			'prev_html' => '<a href="{URL}" class="paging-prev">' . esc_html__( '« Previous Entries', 'app' ) . '</a>',

			// modify the text of the next page link
			'next_html' => '<a href="{URL}" class="paging-next">' . esc_html__( 'Next Entries »', 'app' ) . '</a>',
		);
