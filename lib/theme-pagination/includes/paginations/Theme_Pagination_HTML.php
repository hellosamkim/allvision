<?php
/**
 * The Theme Pagination HTML class.
 * Contains and manages the pagination HTML settings.
 * Abstract, can be extended by all specific pagination types.
 *
 * @uses Theme_Pagination
 */
abstract class Theme_Pagination_HTML extends Theme_Pagination {
	...
	public function render( $echo = true ) {
		$presenter = new Theme_Pagination_Presenter( $this );
