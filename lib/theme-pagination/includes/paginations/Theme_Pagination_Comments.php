<?php
/**
 * Theme Pagination - comments pagination class.
 * Provides the pagination for comments within a post/page.
 *
 * @uses Theme_Pagination_HTML
 */
class Theme_Pagination_Comments extends Theme_Pagination_HTML {
	...
	public function __construct( $args = array() ) {
		...
		$this->default_args = array(
			...
			'prev_html' => '<a href="{URL}" class="paging-prev">' . esc_html__( '« Older Comments', 'app' ) . '</a>',

			// modify the text of the next page link
			'next_html' => '<a href="{URL}" class="paging-next">' . esc_html__( 'Newer Comments »', 'app' ) . '</a>',
		);
