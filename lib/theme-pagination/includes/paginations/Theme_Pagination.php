...
abstract class Theme_Pagination {
	 ...
	 */
	protected $collection = 'Theme_Pagination_Collection';

	/**
	 * @var string The class name of the pagination renderer object.
	 */
	protected $renderer = 'Theme_Pagination_Renderer';

	/**
	 * @var array 
	 * 
	 * The default argument values. Can be declared in the inheriting classes.
	 * Will override the default configuration options in Theme_Pagination::__construct
	...
	public function __construct( $args = array() ) {
		...
		$defaults = apply_filters( 'theme_pagination_default_options', $this->default_args, $this );
